...
interface IAnarkalendarCardProps {
  setActiveView: (view: string) => void;
}

const IAnarkalendarCard = ({ setActiveView }: IAnarkalendarCardProps) => {
  const handleMissionClick = () => {
    setActiveView('armeria-ianarkalendar');
  };
    ...
    >
      ...
      <div className="p-6 flex-1 flex flex-col text-center">
        ...
        <p className="text-gris-neutro font-plex-sans text-sm leading-relaxed mb-6">
          Nuestro calendario Punk-Hacked. 0 dependencias. Una pequeña muestra de soberanía.
        </p>
        <button
...
export default IAnarkalendarCard;