...
interface BarChafyCardProps {
  setActiveView: (view: string) => void;
}

const BarChafyCard = ({ setActiveView }: BarChafyCardProps) => {
  const handleMissionClick = () => {
    setActiveView('armeria-barchafy');
  };
    ...
    >
      ...
      <div className="p-6 flex-1 flex flex-col text-center">
        ...
        <p className="text-gris-neutro font-plex-sans text-sm leading-relaxed mb-6">
          Misión: Recordar nuestro primer proyecto universitario . No volver a cometer los mismos errores
        </p>
        <button
