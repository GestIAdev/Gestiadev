...
const MigracionCard = ({ setActiveView }: MigracionCardProps) => {
  const handleMissionClick = () => {
    setActiveView('armeria-migracion');
  };
  ...
  return (
    ...
    >
      ...
      <div className="h-40">
        <motion.img
          src="/migracion-icon.svg"
          alt="Migración 1-Click Icon"
      ...
      <div className="p-6 flex-1 flex flex-col text-center">
        ...
        <p className="text-gris-neutro font-plex-sans text-sm leading-relaxed mb-6">
          Doctrina de Liberación - De Datos Legacy a Libertad Digital sin costes extra
        </p>
        <button
