...
interface RedNomadaCardProps {
  setActiveView: (view: string) => void;
}

const RedNomadaCard = ({ setActiveView }: RedNomadaCardProps) => {
  const handleMissionClick = () => {
    setActiveView('armeria-rednomada');
  };
  ...
  return (
    ...
    >
      ...
      <div className="h-40">
        <motion.img
          src="/rednomada-icon.svg"
          alt="La Red Nómada Icon"
      ...
      <div className="p-6 flex-1 flex flex-col text-center">
        <h3 className="text-xl font-plex-mono text-menta font-bold mb-3 group-hover:text-hueso transition-colors">
          La Red Nómada (Proyecto Cero)
        </h3>
        <p className="text-gris-neutro font-plex-sans text-sm leading-relaxed mb-6">
          Nuestra visión de una red social 100% soberana, gratuita y antisistema.
        </p>
        <button
